# Generated by Django 5.0.3 on 2024-04-10 06:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(blank=True, choices=[('G', 'General Audiences'), ('PG', 'Parental Guidance Suggested'), ('PG-13', 'Inappropriate for Children Under 13'), ('R', 'Restricted'), ('NC-17', 'Adults Only')], default='G', null=True)),
                ('last_update', models.DateTimeField(auto_now_add=True)),
                ('special_features', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, null=True, size=None)),
